...
public interface AlipayService {
     ...
     * @param subject       商品名称
     */
    String webPagePay(String outTradeNo, float totalAmount, String subject) throws Exception;
     ...
     * @param subject       商品名称
     */
    String appPagePay(String outTradeNo, float totalAmount, String subject) throws Exception;
