...
import com.example.graduation_design.Config.AlipayConfig;
...
public class AlipayServiceImpI implements AlipayService{
     ...
     */
    @Override
    public String webPagePay(String outTradeNo, float totalAmount, String subject) throws Exception {
     ...
     */
    @Override
    public String appPagePay(String outTradeNo, float totalAmount, String subject) throws Exception {
        ...
        wapPayModel.setTotalAmount(String.valueOf(totalAmount));
